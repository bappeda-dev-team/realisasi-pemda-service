...
@Schema(name = "FaktorPenghambatSasaranRequest", description = "Payload untuk memperbarui faktor penghambat pada realisasi sasaran pemda")
public record FaktorPenghambatSasaranRequest(
        ...
        @Schema(description = "Faktor penghambat sasaran pemda", example = "Keterbatasan anggaran")
