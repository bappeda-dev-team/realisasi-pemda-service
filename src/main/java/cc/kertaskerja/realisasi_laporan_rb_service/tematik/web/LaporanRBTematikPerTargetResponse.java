...
@Schema(description = "Laporan realisasi RB tematik per target (baris flat, siap render tabel laporan)")
public record LaporanRBTematikPerTargetResponse(
    ...
    @Schema(description = "Baris laporan per target indikator RB tematik")
    public record BarisLaporanResponse(
            ...
            @Schema(description = "Target pada tahun berjalan", example = "10.0")
            String target,
    ...
    @Schema(description = "Realisasi pada satu target RB tematik")
