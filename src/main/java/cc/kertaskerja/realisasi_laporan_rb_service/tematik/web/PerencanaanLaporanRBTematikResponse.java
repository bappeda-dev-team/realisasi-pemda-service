...
public record PerencanaanLaporanRBTematikResponse(
        ...
        @Schema(description = "Daftar laporan RB tematik yang direalisasikan oleh pegawai")
        List<LaporanPerencanaanResponse> laporans
) {
    @Schema(description = "Laporan RB tematik tingkat laporan")
    public record LaporanPerencanaanResponse(
            @Schema(description = "ID laporan RB", example = "1")
            Long id,

            @JsonProperty("jenis_rb")
            @Schema(description = "Jenis RB", example = "TEMATIK")
            String jenisRb,
    ...
    @Schema(description = "Indikator laporan RB tematik")
    ...
    @Schema(description = "Target indikator RB tematik yang sudah digabung dengan realisasi")
    ...
    @Schema(description = "Rencana aksi laporan RB tematik (tidak mengandung realisasi)")
