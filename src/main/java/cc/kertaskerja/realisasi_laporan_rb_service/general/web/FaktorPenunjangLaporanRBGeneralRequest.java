...
@Schema(name = "FaktorPenunjangLaporanRBGeneralRequest", description = "Payload untuk memperbarui faktor penunjang pada realisasi laporan RB general")
public record FaktorPenunjangLaporanRBGeneralRequest(
        ...
        @Schema(description = "Faktor penunjang laporan RB general", example = "Kerjasama antar daerah")
