...
@Schema(name = "LaporanRealisasiRenjaProgramIndividuResponse", description = "Response laporan realisasi renja individu tingkat program per periode")
public record LaporanRealisasiRenjaProgramIndividuResponse(
