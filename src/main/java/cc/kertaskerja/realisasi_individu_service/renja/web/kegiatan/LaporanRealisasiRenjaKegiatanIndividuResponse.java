...
@Schema(name = "LaporanRealisasiRenjaKegiatanIndividuResponse", description = "Response laporan realisasi renja individu tingkat kegiatan per periode")
public record LaporanRealisasiRenjaKegiatanIndividuResponse(
        ...
        @Schema(description = "Nama kegiatan", example = "Kegiatan A")
        String kegiatan,
