package cc.kertaskerja.integration.perencanaan.laporanrbtematik;

import com.fasterxml.jackson.annotation.JsonProperty;

import java.util.List;

public class LaporanRBTematik {

    public record LaporanRBTematikData(
            Long id,
