...
public class TujuanOpdControllerWebFluxTests {
    ...
    void whenBatchSubmit_thenReturnsSavedTujuans() throws Exception {
        // prepare requests
        TujuanOpdRequest r1 = new TujuanOpdRequest(null, "T1", "I1", "TAR-1", "100.0", 50.0, "unit1", "2025", "1", JenisRealisasi.NAIK, "001", "(realisasi/target)*100", "SIMDA");
        TujuanOpdRequest r2 = new TujuanOpdRequest(null, "T2", "I2", "TAR-2", "200.0", 75.0, "unit2", "2026", "2", JenisRealisasi.TURUN, "001", "(realisasi/target)*100", "SAKIP");
