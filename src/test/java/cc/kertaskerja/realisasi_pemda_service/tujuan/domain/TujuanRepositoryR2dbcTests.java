...
public class TujuanRepositoryR2dbcTests {
    ...
    void findRealisasiTujuanByPeriodeRpjmd() {
        var realisasi2025 = TujuanService.buildUncheckedRealisasiTujuan("1", "123", "10.0", 10.0, "%", "2025", JenisRealisasi.NAIK);
        var realisasi2026 = TujuanService.buildUncheckedRealisasiTujuan("1", "123", "12.0", 12.0, "%", "2026", JenisRealisasi.NAIK);
        StepVerifier.create(
                tujuanRepository
